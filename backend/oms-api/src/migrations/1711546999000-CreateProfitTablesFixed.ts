...
export class CreateProfitTablesFixed1711546999000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      VALUES (1711546999000, 'CreateProfitTablesFixed1711546999000')
    `);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DELETE FROM migrations WHERE name = 'CreateProfitTablesFixed1711546999000'`);
  }
} 